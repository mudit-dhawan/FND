...
def create_multimodal_space_df(MULTIMODAL_SPACE_DIM):
    ...
    ## Set the columns as Multimodal_Dim + label + sample numnber (individual news sample components
    cols_space = cols + ['sample_no', 'label']
    
    ## Set the columns as Multimodal_Dim + label + cluster distance (similarity measure for the sample)
